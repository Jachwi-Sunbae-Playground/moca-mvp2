    ...
    <main className="login-page">
      <section className="login-card" aria-labelledby="login-heading">
        <header className="brand-header">
          <img className="brand-logo" src={jachwiSunbaeLogo} alt="자취의 모든 순간, 믿고 찾는 든든한 선배 자취선배" />
          <p className="brand-message">처음 방을 보는 날부터, 떠나는 날까지.</p>
        </header>

        <section className="guide-section" aria-labelledby="login-heading">
        ...
        <section className="login-actions" aria-label="로그인">
          ...
          <button className="google-login-button" type="button" onClick={handleLogin} disabled={isRedirecting}>
            <GoogleIcon />
            {isRedirecting ? 'Google로 이동 중…' : 'Google로 로그인하기'}
          </button>
          <p className="session-note">새로고침하거나 새 탭을 열면 다시 로그인해야 해요.</p>
